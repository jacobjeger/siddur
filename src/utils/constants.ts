export const ZMAN_NAMES: Record<string, { en: string; he: string }> = {
  ...
  chatzos: { en: "Chatzos (Midday)", he: "חצות היום" },
  minchaGedola: { en: "Mincha Gedola", he: "מנחה גדולה" },
  minchaKetana: { en: "Mincha Ketana", he: "מנחה קטנה" },
