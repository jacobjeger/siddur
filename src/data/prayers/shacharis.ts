...
export const birchosShachar: Tefila = {
  ...
  sections: [
    ...
    },
    {
      ...
      titleHe: "ברכות התורה",
      instruction:
        "The blessings over Torah study. After the brachos, pesukim from Birkas Kohanim are recited as the first Torah learning of the day.",
...
export const shirShelYom: Tefila = {
  ...
  sections: [
    ...
    {
      id: "shir-yom-shabbos",
      title: "Shabbos - Psalm 92",
      titleHe: "יום שבת - תהלים צב",
      instruction: "The psalm for Shabbos. The Levites would recite this psalm in the Temple.",
      text: "הַיּוֹם יוֹם שַׁבָּת קֹדֶשׁ, שֶׁבּוֹ הָיוּ הַלְוִיִּם אוֹמְרִים בְּבֵית הַמִּקְדָּשׁ:\n\nמִזְמוֹר שִׁיר לְיוֹם הַשַּׁבָּת. טוֹב לְהֹדוֹת לַה', וּלְזַמֵּר לְשִׁמְךָ עֶלְיוֹן. לְהַגִּיד בַּבֹּקֶר חַסְדֶּךָ, וֶאֱמוּנָתְךָ בַּלֵּילוֹת. עֲלֵי עָשׂוֹר וַעֲלֵי נָבֶל, עֲלֵי הִגָּיוֹן בְּכִנּוֹר. כִּי שִׂמַּחְתַּנִי ה' בְּפָעֳלֶךָ, בְּמַעֲשֵׂי יָדֶיךָ אֲרַנֵּן. מַה גָּדְלוּ מַעֲשֶׂיךָ ה', מְאֹד עָמְקוּ מַחְשְׁבוֹתֶיךָ. אִישׁ בַּעַר לֹא יֵדָע, וּכְסִיל לֹא יָבִין אֶת זֹאת. בִּפְרֹחַ רְשָׁעִים כְּמוֹ עֵשֶׂב, וַיָּצִיצוּ כָּל פֹּעֲלֵי אָוֶן, לְהִשָּׁמְדָם עֲדֵי עַד. וְאַתָּה מָרוֹם לְעוֹלָם ה'. כִּי הִנֵּה אוֹיְבֶיךָ ה', כִּי הִנֵּה אוֹיְבֶיךָ יֹאבֵדוּ, יִתְפָּרְדוּ כָּל פֹּעֲלֵי אָוֶן. וַתָּרֶם כִּרְאֵים קַרְנִי, בַּלֹּתִי בְּשֶׁמֶן רַעֲנָן. וַתַּבֵּט עֵינִי בְּשׁוּרָי, בַּקָּמִים עָלַי מְרֵעִים תִּשְׁמַעְנָה אָזְנָי. צַדִּיק כַּתָּמָר יִפְרָח, כְּאֶרֶז בַּלְּבָנוֹן יִשְׂגֶּה. שְׁתוּלִים בְּבֵית ה', בְּחַצְרוֹת אֱלֹהֵינוּ יַפְרִיחוּ. עוֹד יְנוּבוּן בְּשֵׂיבָה, דְּשֵׁנִים וְרַעֲנַנִּים יִהְיוּ. לְהַגִּיד כִּי יָשָׁר ה', צוּרִי וְלֹא עַוְלָתָה בּוֹ.",
      translation: "Today is the holy Sabbath day, on which the Levites would recite in the Temple:\n\nA psalm, a song for the Sabbath day. It is good to give thanks to the Lord, and to sing praises to Your Name, O Most High. To declare Your kindness in the morning, and Your faithfulness at night. Upon a ten-stringed instrument and upon a lute, with meditation upon the harp. For You have made me glad, O Lord, with Your deeds; I sing for joy at the works of Your hands. How great are Your works, O Lord; how very deep are Your thoughts. A boorish man does not know, nor does a fool understand this: When the wicked bloom like grass, and all the doers of iniquity blossom—it is to destroy them forever. But You are exalted forever, O Lord. For behold, Your enemies, O Lord, for behold, Your enemies shall perish; all the doers of iniquity shall be scattered. You have raised my horn like that of a wild ox; I am anointed with fresh oil. My eyes have seen the downfall of my watchful enemies; my ears have heard the doom of the evildoers who rise up against me. The righteous shall flourish like a palm tree, he shall grow like a cedar in Lebanon. Planted in the House of the Lord, they shall flourish in the courtyards of our God. They shall still bring forth fruit in old age; they shall be full of sap and freshness. To declare that the Lord is upright; He is my Rock, and there is no injustice in Him.",
    },
  ],
};
