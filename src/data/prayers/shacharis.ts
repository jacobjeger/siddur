  ...
  sections: [
    {
      ...
      title: "Modeh Ani",
      titleHe: "מודה אני",
      instruction: "Said immediately upon waking, before washing hands. Women say 'Modah Ani.'",
    ...
    },
    {
      ...
      title: "Torah Study",
      titleHe: "לימוד תורה",
      instruction: "After Birchos HaTorah, it is customary to learn Torah passages: Birkas Kohanim, a mishnah from Peah, and a baraisa.",
      text: "יְבָרֶכְךָ ה' וְיִשְׁמְרֶךָ.\nיָאֵר ה' פָּנָיו אֵלֶיךָ וִיחֻנֶּךָּ.\nיִשָּׂא ה' פָּנָיו אֵלֶיךָ וְיָשֵׂם לְךָ שָׁלוֹם.\n\nאֵלּוּ דְבָרִים שֶׁאֵין לָהֶם שִׁעוּר: הַפֵּאָה, וְהַבִּכּוּרִים, וְהָרֵאָיוֹן, וּגְמִילוּת חֲסָדִים, וְתַלְמוּד תּוֹרָה.\n\nאֵלּוּ דְבָרִים שֶׁאָדָם אוֹכֵל פֵּרוֹתֵיהֶם בָּעוֹלָם הַזֶּה, וְהַקֶּרֶן קַיֶּמֶת לוֹ לָעוֹלָם הַבָּא, וְאֵלּוּ הֵן: כִּבּוּד אָב וָאֵם, וּגְמִילוּת חֲסָדִים, וְהַשְׁכָּמַת בֵּית הַמִּדְרָשׁ שַׁחֲרִית וְעַרְבִית, וְהַכְנָסַת אוֹרְחִים, וּבִקּוּר חוֹלִים, וְהַכְנָסַת כַּלָּה, וּלְוָיַת הַמֵּת, וְעִיּוּן תְּפִלָּה, וַהֲבָאַת שָׁלוֹם בֵּין אָדָם לַחֲבֵרוֹ, וְתַלְמוּד תּוֹרָה כְּנֶגֶד כֻּלָּם.",
      translation: "May the Lord bless you and guard you.\nMay the Lord make His face shine upon you and be gracious to you.\nMay the Lord turn His face toward you and grant you peace.\n\nThese are things that have no prescribed measure: the corner of the field, the first fruits, the pilgrimage offering, acts of kindness, and Torah study.\n\nThese are things whose fruits a person enjoys in this world, while the principal remains for the World to Come: honoring father and mother, acts of kindness, early attendance at the house of study morning and evening, hospitality to guests, visiting the sick, providing for a bride, escorting the dead, concentration in prayer, bringing peace between people—and the study of Torah is equal to them all.",
    },
    {
      id: "akeidas-yitzchak",
  ...
  sections: [
    {
      ...
      title: "Mizmor Shir",
      titleHe: "מזמור שיר",
      instruction: "Psalm 30 — Introductory psalm before Pesukei D'Zimra.",
      text: "מִזְמוֹר שִׁיר חֲנֻכַּת הַבַּיִת לְדָוִד.\nאֲרוֹמִמְךָ ה' כִּי דִלִּיתָנִי, וְלֹא שִׂמַּחְתָּ אוֹיְבַי לִי.\nה' אֱלֹהָי, שִׁוַּעְתִּי אֵלֶיךָ וַתִּרְפָּאֵנִי.\nה', הֶעֱלִיתָ מִן שְׁאוֹל נַפְשִׁי, חִיִּיתַנִי מִיָּרְדִי בוֹר.\nזַמְּרוּ לַה' חֲסִידָיו, וְהוֹדוּ לְזֵכֶר קָדְשׁוֹ.\nכִּי רֶגַע בְּאַפּוֹ, חַיִּים בִּרְצוֹנוֹ, בָּעֶרֶב יָלִין בֶּכִי, וְלַבֹּקֶר רִנָּה.\nוַאֲנִי אָמַרְתִּי בְשַׁלְוִי, בַּל אֶמּוֹט לְעוֹלָם.\nה', בִּרְצוֹנְךָ הֶעֱמַדְתָּה לְהַרְרִי עֹז, הִסְתַּרְתָּ פָנֶיךָ, הָיִיתִי נִבְהָל.\nאֵלֶיךָ ה' אֶקְרָא, וְאֶל אֲדֹנָי אֶתְחַנָּן.\nמַה בֶּצַע בְּדָמִי, בְּרִדְתִּי אֶל שָׁחַת, הֲיוֹדְךָ עָפָר, הֲיַגִּיד אֲמִתֶּךָ.\nשְׁמַע ה' וְחָנֵּנִי, ה' הֱיֵה עוֹזֵר לִי.\nהָפַכְתָּ מִסְפְּדִי לְמָחוֹל לִי, פִּתַּחְתָּ שַׂקִּי וַתְּאַזְּרֵנִי שִׂמְחָה.\nלְמַעַן יְזַמֶּרְךָ כָבוֹד וְלֹא יִדּוֹם, ה' אֱלֹהַי, לְעוֹלָם אוֹדֶךָּ.",
      translation: "A psalm, a song for the dedication of the House, by David.\nI will exalt You, Lord, for You have lifted me up, and have not let my enemies rejoice over me.\nLord my God, I cried out to You, and You healed me.\nLord, You brought up my soul from the grave; You kept me alive, that I should not go down to the pit.\nSing praise to the Lord, you His pious ones, and give thanks to His holy Name.\nFor His anger lasts but a moment, life results from His favor; in the evening one lies down weeping, but in the morning there is a song of joy.\nIn my prosperity I said: I shall never be moved.\nLord, by Your favor You made my mountain stand strong; You hid Your face, and I was dismayed.\nTo You, Lord, I called, and to my Lord I made supplication.\nWhat profit is there in my blood, in my going down to the pit? Can the dust praise You? Can it declare Your truth?\nHear, Lord, and be gracious to me; Lord, be my helper.\nYou turned my mourning into dancing; You removed my sackcloth and clothed me with joy.\nSo that my soul may sing praise to You and not be silent; Lord my God, I will give thanks to You forever.",
    },
    {
      id: "baruch-sheamar",
    ...
    },
    {
      ...
      titleHe: "ויברך דוד",
      instruction: "1 Chronicles 29:10-13. David's blessing before the entire congregation.",
      text: "וַיְבָרֶךְ דָּוִד אֶת ה' לְעֵינֵי כָּל הַקָּהָל, וַיֹּאמֶר דָּוִד: בָּרוּךְ אַתָּה ה' אֱלֹהֵי יִשְׂרָאֵל אָבִינוּ, מֵעוֹלָם וְעַד עוֹלָם. לְךָ ה' הַגְּדֻלָּה וְהַגְּבוּרָה וְהַתִּפְאֶרֶת וְהַנֵּצַח וְהַהוֹד, כִּי כֹל בַּשָּׁמַיִם וּבָאָרֶץ, לְךָ ה' הַמַּמְלָכָה וְהַמִּתְנַשֵּׂא לְכֹל לְרֹאשׁ. וְהָעֹשֶׁר וְהַכָּבוֹד מִלְּפָנֶיךָ, וְאַתָּה מוֹשֵׁל בַּכֹּל, וּבְיָדְךָ כֹּחַ וּגְבוּרָה, וּבְיָדְךָ לְגַדֵּל וּלְחַזֵּק לַכֹּל. וְעַתָּה אֱלֹהֵינוּ מוֹדִים אֲנַחְנוּ לָךְ, וּמְהַלְלִים לְשֵׁם תִּפְאַרְתֶּךָ.",
      translation: "David blessed the Lord in the sight of the entire congregation, and David said: Blessed are You, Lord, God of Israel our father, from world to world. Yours, O Lord, is the greatness, the power, the glory, the victory, and the majesty; for all that is in heaven and earth is Yours. Yours, O Lord, is the kingdom, and You are exalted as head above all. Riches and honor are from before You, and You rule over all. In Your hand is power and might, and in Your hand is the ability to make great and to give strength to all. And now, our God, we give thanks to You and praise Your glorious Name.",
    },
    {
      id: "yehi-chevod",
      title: "Yehi Chevod",
    ...
    },
    {
      ...
      translation: "Praiseworthy are those who dwell in Your house; they will continue to praise You, Selah.\nPraiseworthy is the people for whom this is so; praiseworthy is the people whose God is the Lord.\n\nA psalm of praise by David:\nI will exalt You, my God the King, and I will bless Your Name forever and ever.\nEvery day I will bless You, and I will praise Your Name forever and ever.\nGreat is the Lord and exceedingly praised, and His greatness is unfathomable.\nEach generation will praise Your deeds to the next, and they will tell of Your mighty acts.\nThe splendor of Your glorious majesty, and Your wondrous deeds I will speak of.\nThey will talk of the might of Your awesome acts, and I will recount Your greatness.\nThey will express the remembrance of Your abundant goodness, and sing of Your righteousness.\nGracious and merciful is the Lord, slow to anger and great in kindness.\nThe Lord is good to all, and His mercy is upon all His works.\nAll Your works will thank You, Lord, and Your pious ones will bless You.\nThey will speak of the glory of Your kingdom, and tell of Your might.\nTo make known to people His mighty acts, and the glorious splendor of His kingdom.\nYour kingdom is a kingdom of all worlds, and Your dominion is in every generation.\nThe Lord supports all the fallen, and straightens all the bent.\nThe eyes of all look hopefully to You, and You give them their food in its time.\nYou open Your hand, and satisfy the desire of every living thing.\nRighteous is the Lord in all His ways, and kind in all His deeds.\nThe Lord is close to all who call upon Him, to all who call upon Him in truth.\nHe fulfills the desire of those who fear Him, He hears their cry and saves them.\nThe Lord guards all who love Him, and He will destroy all the wicked.\nMy mouth will speak the praise of the Lord, and all flesh will bless His holy Name forever and ever.\n\nAnd we will bless God from now and forever, Hallelujah!",
    },
    {
      id: "psalm-146",
      title: "Psalm 146",
    ...
    },
    {
      ...
      translation: "Hallelujah! For it is good to sing to our God, for praise is pleasant and fitting.\nThe Lord builds Jerusalem, He gathers the outcasts of Israel.\nHe heals the brokenhearted, and bandages their wounds.\nHe counts the number of the stars, He gives a name to each of them.\nGreat is our Lord and abundant in power; His understanding is beyond measure.\nThe Lord encourages the humble, He casts the wicked to the ground.\nSing to the Lord with thanks, make music to our God with the harp.\nHe covers the heavens with clouds, prepares rain for the earth, makes grass grow upon the mountains.\nHe gives the animal its food, to the young ravens that cry out.\nHe does not desire the might of the horse, He does not want the legs of man.\nThe Lord desires those who fear Him, those who hope for His kindness.\nPraise the Lord, O Jerusalem; laud your God, O Zion.\nFor He has strengthened the bars of your gates, He has blessed your children in your midst.\nHe establishes peace at your borders, He satiates you with the finest wheat.\nHe sends His command to the earth, His word runs swiftly.\nHe gives snow like wool, He scatters frost like ashes.\nHe hurls His ice like crumbs; who can stand before His cold?\nHe sends His word and melts them, He blows His wind and the waters flow.\nHe tells His words to Jacob, His statutes and His judgments to Israel.\nHe did not do so for any other nation; they do not know His judgments. Hallelujah!",
    },
    {
      id: "psalm-148",
      title: "Psalm 148",
    ...
    },
    {
      ...
      titleHe: "פסוקי דזמרא - סיום",
      text: "בָּרוּךְ ה' לְעוֹלָם, אָמֵן וְאָמֵן.\nבָּרוּךְ ה' מִצִּיּוֹן, שׁוֹכֵן יְרוּשָׁלָיִם, הַלְלוּיָהּ.\nבָּרוּךְ ה' אֱלֹהִים, אֱלֹהֵי יִשְׂרָאֵל, עוֹשֵׂה נִפְלָאוֹת לְבַדּוֹ.\nוּבָרוּךְ שֵׁם כְּבוֹדוֹ לְעוֹלָם, וְיִמָּלֵא כְבוֹדוֹ אֶת כָּל הָאָרֶץ, אָמֵן וְאָמֵן.",
      translation: "Blessed is the Lord forever, Amen and Amen.\nBlessed is the Lord from Zion, Who dwells in Jerusalem, Hallelujah.\nBlessed is the Lord God, the God of Israel, Who alone does wonders.\nAnd blessed is the Name of His glory forever, and may His glory fill the whole earth, Amen and Amen.",
    },
    {
      id: "ata-hu",
      title: "Ata Hu",
      titleHe: "אתה הוא",
      text: "אַתָּה הוּא ה' לְבַדֶּךָ, אַתָּה עָשִׂיתָ אֶת הַשָּׁמַיִם, שְׁמֵי הַשָּׁמַיִם וְכָל צְבָאָם, הָאָרֶץ וְכָל אֲשֶׁר עָלֶיהָ, הַיַּמִּים וְכָל אֲשֶׁר בָּהֶם, וְאַתָּה מְחַיֶּה אֶת כֻּלָּם, וּצְבָא הַשָּׁמַיִם לְךָ מִשְׁתַּחֲוִים.\n\nאַתָּה הוּא ה' הָאֱלֹהִים, אֲשֶׁר בָּחַרְתָּ בְּאַבְרָם, וְהוֹצֵאתוֹ מֵאוּר כַּשְׂדִּים, וְשַׂמְתָּ שְׁמוֹ אַבְרָהָם.",
      translation: "You alone are the Lord; You made the heavens, the heavens of heavens and all their hosts, the earth and all that is upon it, the seas and all that is in them, and You give life to them all, and the hosts of heaven bow to You.\n\nYou are the Lord God, Who chose Abram, brought him out of Ur of the Chaldees, and changed his name to Abraham.",
    },
    {
      id: "az-yashir",
      title: "Az Yashir",
...
export const shemaShacharis: Tefila = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: "בָּרוּךְ אַתָּה ה' אֱלֹהֵינוּ מֶלֶךְ הָעוֹלָם, יוֹצֵר אוֹר וּבוֹרֵא חוֹשֶׁךְ, עוֹשֶׂה שָׁלוֹם וּבוֹרֵא אֶת הַכֹּל.\n\nהַמֵּאִיר לָאָרֶץ וְלַדָּרִים עָלֶיהָ בְּרַחֲמִים, וּבְטוּבוֹ מְחַדֵּשׁ בְּכָל יוֹם תָּמִיד מַעֲשֵׂה בְרֵאשִׁית. מָה רַבּוּ מַעֲשֶׂיךָ ה', כֻּלָּם בְּחָכְמָה עָשִׂיתָ, מָלְאָה הָאָרֶץ קִנְיָנֶךָ. הַמֶּלֶךְ הַמְרוֹמָם לְבַדּוֹ מֵאָז, הַמְשֻׁבָּח וְהַמְפֹאָר וְהַמִּתְנַשֵּׂא מִימוֹת עוֹלָם. אֱלֹהֵי עוֹלָם, בְּרַחֲמֶיךָ הָרַבִּים רַחֵם עָלֵינוּ, אֲדוֹן עֻזֵּנוּ, צוּר מִשְׂגַּבֵּנוּ, מָגֵן יִשְׁעֵנוּ, מִשְׂגָּב בַּעֲדֵנוּ.\n\nאֵל בָּרוּךְ גְּדוֹל דֵּעָה, הֵכִין וּפָעַל זָהֳרֵי חַמָּה. טוֹב יָצַר כָּבוֹד לִשְׁמוֹ, מְאוֹרוֹת נָתַן סְבִיבוֹת עֻזּוֹ. פִּנּוֹת צְבָאָיו קְדוֹשִׁים, רוֹמְמֵי שַׁדַּי, תָּמִיד מְסַפְּרִים כְּבוֹד אֵל וּקְדֻשָּׁתוֹ.\n\nתִּתְבָּרַךְ ה' אֱלֹהֵינוּ עַל שֶׁבַח מַעֲשֵׂה יָדֶיךָ, וְעַל מְאוֹרֵי אוֹר שֶׁעָשִׂיתָ, יְפָאֲרוּךָ סֶּלָה.\n\nהַכֹּל יוֹדוּךָ, וְהַכֹּל יְשַׁבְּחוּךָ, וְהַכֹּל יֹאמְרוּ אֵין קָדוֹשׁ כַּה'. הַכֹּל יְרוֹמְמוּךָ סֶּלָה, יוֹצֵר הַכֹּל. הָאֵל הַפּוֹתֵחַ בְּכָל יוֹם דַּלְתוֹת שַׁעֲרֵי מִזְרָח, וּבוֹקֵעַ חַלּוֹנֵי רָקִיעַ, מוֹצִיא חַמָּה מִמְּקוֹמָהּ, וּלְבָנָה מִמְּכוֹן שִׁבְתָּהּ, וּמֵאִיר לָעוֹלָם כֻּלוֹ וּלְיוֹשְׁבָיו שֶׁבָּרָא בְּמִדַּת הָרַחֲמִים.\n\nהַמֵּאִיר לָאָרֶץ וְלַדָּרִים עָלֶיהָ בְּרַחֲמִים, וּבְטוּבוֹ מְחַדֵּשׁ בְּכָל יוֹם תָּמִיד מַעֲשֵׂה בְרֵאשִׁית. מָה רַבּוּ מַעֲשֶׂיךָ ה', כֻּלָּם בְּחָכְמָה עָשִׂיתָ, מָלְאָה הָאָרֶץ קִנְיָנֶךָ. תִּתְבָּרַךְ ה' אֱלֹהֵינוּ עַל שֶׁבַח מַעֲשֵׂה יָדֶיךָ, וְעַל מְאוֹרֵי אוֹר שֶׁעָשִׂיתָ, יְפָאֲרוּךָ סֶּלָה.\n\nאוֹר חָדָשׁ עַל צִיּוֹן תָּאִיר, וְנִזְכֶּה כֻלָּנוּ מְהֵרָה לְאוֹרוֹ.",
      translation: "Blessed are You, Lord our God, King of the universe, Who forms light and creates darkness, Who makes peace and creates all.\n\nHe illuminates the earth and those who dwell upon it with mercy, and in His goodness renews each day continually the work of creation. How manifold are Your works, O Lord! In wisdom You have made them all; the earth is full of Your possessions. The King Who alone is exalted from of old, praised, glorified, and uplifted since the days of the world. Eternal God, in Your abundant mercy have mercy upon us, Master of our strength, Rock of our stronghold, Shield of our salvation, Stronghold on our behalf.\n\nThe blessed God, great in knowledge, prepared and made the rays of the sun. The Good One created glory for His Name, He placed luminaries around His might. The leaders of His hosts are holy beings that exalt the Almighty, constantly declaring the glory of God and His holiness.\n\nBe blessed, Lord our God, for the excellence of Your handiwork, and for the luminaries of light that You have made; they shall glorify You forever.\n\nAll will thank You, all will praise You, and all will say: There is none holy like the Lord. All will exalt You forever, Creator of all. The God Who opens each day the doors of the gates of the east, and splits the windows of the firmament, bringing forth the sun from its place and the moon from its abode, illuminating the whole world and its inhabitants whom He created with the attribute of mercy.\n\nHe illuminates the earth and those who dwell upon it with mercy, and in His goodness renews each day continually the work of creation. How manifold are Your works, O Lord! In wisdom You have made them all; the earth is full of Your possessions. Be blessed, Lord our God, for the excellence of Your handiwork, and for the luminaries of light that You made—they shall glorify You forever.\n\nShine a new light upon Zion, and may we all speedily merit its light.",
    },
    {
      id: "kedusha-dyotzer",
      title: "Kedusha D'Yotzer",
      titleHe: "קדושת יוצר",
      instruction: "The Kedusha within Yotzer Ohr. This is said even when praying alone.",
      text: "לָאֵל בָּרוּךְ נְעִימוֹת יִתֵּנוּ, לַמֶּלֶךְ אֵל חַי וְקַיָּם, זְמִירוֹת יֹאמֵרוּ וְתִשְׁבָּחוֹת יַשְׁמִיעוּ. כִּי הוּא לְבַדּוֹ מָרוֹם וְקָדוֹשׁ, פּוֹעֵל גְּבוּרוֹת, עוֹשֶׂה חֲדָשׁוֹת, בַּעַל מִלְחָמוֹת, זוֹרֵעַ צְדָקוֹת, מַצְמִיחַ יְשׁוּעוֹת, בּוֹרֵא רְפוּאוֹת, נוֹרָא תְהִלּוֹת, אֲדוֹן הַנִּפְלָאוֹת, הַמְחַדֵּשׁ בְּטוּבוֹ בְּכָל יוֹם תָּמִיד מַעֲשֵׂה בְרֵאשִׁית, כָּאָמוּר: לְעוֹשֵׂה אוֹרִים גְּדוֹלִים, כִּי לְעוֹלָם חַסְדּוֹ.\n\nאוֹר חָדָשׁ עַל צִיּוֹן תָּאִיר, וְנִזְכֶּה כֻלָּנוּ מְהֵרָה לְאוֹרוֹ. בָּרוּךְ אַתָּה ה', יוֹצֵר הַמְּאוֹרוֹת.",
      translation: "To the blessed God they will offer sweet songs, to the King, the living and eternal God, they will say hymns and make praises heard. For He alone is exalted and holy, performing mighty deeds, making new things, Master of wars, sowing righteousness, causing salvation to sprout, creating healings, awesome in praise, Lord of wonders, Who in His goodness renews each day continually the work of creation, as it is said: To the One Who makes great lights, for His kindness is forever.\n\nShine a new light upon Zion, and may we all speedily merit its light. Blessed are You, Lord, Who forms the luminaries.",
    },
    {
      id: "ahava-rabba",
      title: "Ahava Rabba",
...
export const tachanun: Tefila = {
  ...
  sections: [
    ...
    {
    {
      ...
      titleHe: "שומר ישראל",
      instruction: "Said on Mondays and Thursdays. A plea for protection.",
      ...
      translation: "Guardian of Israel, guard the remnant of Israel, and let not Israel perish, who say: Hear, O Israel.\n\nGuardian of the unique nation, guard the remnant of the unique people, and let not the unique nation perish, who unify Your Name, saying: The Lord is our God, the Lord is One.\n\nGuardian of the holy nation, guard the remnant of the holy people, and let not the holy nation perish, who repeat the threefold sanctification to the Holy One.",
    },
    {
      id: "v-hu-rachum",
      title: "V'Hu Rachum",
...
export const shirShelYom: Tefila = {
  ...
  sections: [
    ...
    {
      id: "shir-yom-sheini",
      title: "Monday - Psalm 48",
      titleHe: "יום שני - תהלים מח",
      instruction: "The psalm for Monday.",
      text: "הַיּוֹם יוֹם שֵׁנִי בְּשַׁבָּת, שֶׁבּוֹ הָיוּ הַלְוִיִּם אוֹמְרִים בְּבֵית הַמִּקְדָּשׁ:\n\nשִׁיר מִזְמוֹר לִבְנֵי קֹרַח. גָּדוֹל ה' וּמְהֻלָּל מְאֹד, בְּעִיר אֱלֹהֵינוּ הַר קָדְשׁוֹ. יְפֵה נוֹף מְשׂוֹשׂ כָּל הָאָרֶץ, הַר צִיּוֹן יַרְכְּתֵי צָפוֹן, קִרְיַת מֶלֶךְ רָב. אֱלֹהִים בְּאַרְמְנוֹתֶיהָ נוֹדַע לְמִשְׂגָּב. כִּי הִנֵּה הַמְּלָכִים נוֹעֲדוּ, עָבְרוּ יַחְדָּו. הֵמָּה רָאוּ כֵּן תָּמָהוּ, נִבְהֲלוּ נֶחְפָּזוּ. רְעָדָה אֲחָזָתַם שָׁם, חִיל כַּיּוֹלֵדָה. בְּרוּחַ קָדִים תְּשַׁבֵּר אֳנִיּוֹת תַּרְשִׁישׁ. כַּאֲשֶׁר שָׁמַעְנוּ כֵּן רָאִינוּ, בְּעִיר ה' צְבָאוֹת בְּעִיר אֱלֹהֵינוּ, אֱלֹהִים יְכוֹנְנֶהָ עַד עוֹלָם סֶלָה. דִּמִּינוּ אֱלֹהִים חַסְדֶּךָ, בְּקֶרֶב הֵיכָלֶךָ. כְּשִׁמְךָ אֱלֹהִים כֵּן תְּהִלָּתְךָ עַל קַצְוֵי אֶרֶץ, צֶדֶק מָלְאָה יְמִינֶךָ. יִשְׂמַח הַר צִיּוֹן, תָּגֵלְנָה בְּנוֹת יְהוּדָה, לְמַעַן מִשְׁפָּטֶיךָ. סֹבּוּ צִיּוֹן וְהַקִּיפוּהָ, סִפְרוּ מִגְדָּלֶיהָ. שִׁיתוּ לִבְּכֶם לְחֵילָה, פַּסְּגוּ אַרְמְנוֹתֶיהָ, לְמַעַן תְּסַפְּרוּ לְדוֹר אַחֲרוֹן. כִּי זֶה אֱלֹהִים אֱלֹהֵינוּ עוֹלָם וָעֶד, הוּא יְנַהֲגֵנוּ עַל מוּת.",
      translation: "Today is the second day of the week, on which the Levites would recite in the Temple:\n\nA song, a psalm of the sons of Korach. Great is the Lord and highly praised, in the city of our God, His holy mountain. Beautiful in elevation, the joy of the entire earth, Mount Zion, on the northern slopes, city of the great King. God, in her palaces, has become known as a stronghold. For behold, the kings assembled, they advanced together. They saw and were astounded; they were terrified, they fled in haste. Trembling seized them there, pangs like a woman in labor. With an east wind You shattered the ships of Tarshish. As we have heard, so have we seen, in the city of the Lord of hosts, in the city of our God—God will establish it forever, Selah. We have meditated upon Your kindness, O God, in the midst of Your Temple. As Your Name, O God, so is Your praise, to the ends of the earth; Your right hand is full of righteousness. Let Mount Zion rejoice, let the daughters of Judah exult, because of Your judgments. Walk around Zion, encircle her; count her towers. Set your hearts upon her ramparts, raise up her palaces, so that you may tell it to the next generation. For this God is our God forever and ever; He will lead us beyond death.",
    },
    {
      id: "shir-yom-shlishi",
      title: "Tuesday - Psalm 82",
      titleHe: "יום שלישי - תהלים פב",
      instruction: "The psalm for Tuesday.",
      text: "הַיּוֹם יוֹם שְׁלִישִׁי בְּשַׁבָּת, שֶׁבּוֹ הָיוּ הַלְוִיִּם אוֹמְרִים בְּבֵית הַמִּקְדָּשׁ:\n\nמִזְמוֹר לְאָסָף. אֱלֹהִים נִצָּב בַּעֲדַת אֵל, בְּקֶרֶב אֱלֹהִים יִשְׁפֹּט. עַד מָתַי תִּשְׁפְּטוּ עָוֶל, וּפְנֵי רְשָׁעִים תִּשְׂאוּ סֶלָה. שִׁפְטוּ דַל וְיָתוֹם, עָנִי וָרָשׁ הַצְדִּיקוּ. פַּלְּטוּ דַל וְאֶבְיוֹן, מִיַּד רְשָׁעִים הַצִּילוּ. לֹא יָדְעוּ וְלֹא יָבִינוּ, בַּחֲשֵׁכָה יִתְהַלָּכוּ, יִמּוֹטוּ כָּל מוֹסְדֵי אָרֶץ. אֲנִי אָמַרְתִּי אֱלֹהִים אַתֶּם, וּבְנֵי עֶלְיוֹן כֻּלְּכֶם. אָכֵן כְּאָדָם תְּמוּתוּן, וּכְאַחַד הַשָּׂרִים תִּפֹּלוּ. קוּמָה אֱלֹהִים שָׁפְטָה הָאָרֶץ, כִּי אַתָּה תִנְחַל בְּכָל הַגּוֹיִם.",
      translation: "Today is the third day of the week, on which the Levites would recite in the Temple:\n\nA psalm of Asaph. God stands in the divine assembly; among the judges He renders judgment. How long will you judge unjustly, and show favor to the wicked? Selah. Judge the poor and the orphan; vindicate the afflicted and the destitute. Rescue the poor and the needy; deliver them from the hand of the wicked. They do not know, nor do they understand; they walk in darkness; all the foundations of the earth are shaken. I said: You are angels, and all of you are sons of the Most High. But you shall die as men, and fall like one of the princes. Arise, O God, judge the earth, for You inherit all the nations.",
    },
    {
      id: "shir-yom-revii",
      title: "Wednesday - Psalm 94",
      titleHe: "יום רביעי - תהלים צד",
      instruction: "The psalm for Wednesday.",
      text: "הַיּוֹם יוֹם רְבִיעִי בְּשַׁבָּת, שֶׁבּוֹ הָיוּ הַלְוִיִּם אוֹמְרִים בְּבֵית הַמִּקְדָּשׁ:\n\nאֵל נְקָמוֹת ה', אֵל נְקָמוֹת הוֹפִיעַ. הִנָּשֵׂא שׁוֹפֵט הָאָרֶץ, הָשֵׁב גְּמוּל עַל גֵּאִים. עַד מָתַי רְשָׁעִים ה', עַד מָתַי רְשָׁעִים יַעֲלֹזוּ. יַבִּיעוּ יְדַבְּרוּ עָתָק, יִתְאַמְּרוּ כָּל פֹּעֲלֵי אָוֶן. עַמְּךָ ה' יְדַכְּאוּ, וְנַחֲלָתְךָ יְעַנּוּ. אַלְמָנָה וְגֵר יַהֲרוֹגוּ, וִיתוֹמִים יְרַצֵּחוּ. וַיֹּאמְרוּ לֹא יִרְאֶה יָּהּ, וְלֹא יָבִין אֱלֹהֵי יַעֲקֹב. בִּינוּ בֹּעֲרִים בָּעָם, וּכְסִילִים מָתַי תַּשְׂכִּילוּ. הֲנוֹטַע אֹזֶן הֲלֹא יִשְׁמָע, אִם יוֹצֵר עַיִן הֲלֹא יַבִּיט. הֲיוֹסֵר גּוֹיִם הֲלֹא יוֹכִיחַ, הַמְלַמֵּד אָדָם דָּעַת. ה' יוֹדֵעַ מַחְשְׁבוֹת אָדָם כִּי הֵמָּה הָבֶל. אַשְׁרֵי הַגֶּבֶר אֲשֶׁר תְּיַסְּרֶנּוּ יָּהּ, וּמִתּוֹרָתְךָ תְלַמְּדֶנּוּ. לְהַשְׁקִיט לוֹ מִימֵי רָע, עַד יִכָּרֶה לָרָשָׁע שָׁחַת. כִּי לֹא יִטּוֹשׁ ה' עַמּוֹ, וְנַחֲלָתוֹ לֹא יַעֲזוֹב. כִּי עַד צֶדֶק יָשׁוּב מִשְׁפָּט, וְאַחֲרָיו כָּל יִשְׁרֵי לֵב. מִי יָקוּם לִי עִם מְרֵעִים, מִי יִתְיַצֵּב לִי עִם פּוֹעֲלֵי אָוֶן. לוּלֵי ה' עֶזְרָתָה לִּי, כִּמְעַט שָׁכְנָה דוּמָה נַפְשִׁי. אִם אָמַרְתִּי מָטָה רַגְלִי, חַסְדְּךָ ה' יִסְעָדֵנִי. בְּרוֹב שַׂרְעַפַּי בְּקִרְבִּי, תַּנְחוּמֶיךָ יְשַׁעַשְׁעוּ נַפְשִׁי. הַיְחָבְרְךָ כִּסֵּא הַוּוֹת, יוֹצֵר עָמָל עֲלֵי חֹק. יָגוֹדּוּ עַל נֶפֶשׁ צַדִּיק, וְדָם נָקִי יַרְשִׁיעוּ. וַיְהִי ה' לִי לְמִשְׂגָּב, וֵאלֹהַי לְצוּר מַחְסִי. וַיָּשֶׁב עֲלֵיהֶם אֶת אוֹנָם, וּבְרָעָתָם יַצְמִיתֵם, יַצְמִיתֵם ה' אֱלֹהֵינוּ.",
      translation: "Today is the fourth day of the week, on which the Levites would recite in the Temple:\n\nO God of vengeance, Lord; O God of vengeance, appear! Rise up, Judge of the earth; render to the proud their recompense. How long shall the wicked, O Lord, how long shall the wicked exult? They spew forth, speaking arrogantly; all the evildoers boast. They crush Your people, O Lord, and afflict Your heritage. They slay the widow and the stranger, and murder the orphans. And they say: God does not see, the God of Jacob pays no heed. Take heed, you senseless among the people; fools, when will you become wise? He Who implants the ear, does He not hear? He Who forms the eye, does He not see? He Who chastises nations, does He not rebuke—He Who teaches man knowledge? The Lord knows the thoughts of man, that they are futile. Fortunate is the man whom You discipline, O God, and whom You teach from Your Torah. To give him rest from days of adversity, until a pit is dug for the wicked. For the Lord will not abandon His people, nor forsake His heritage. For judgment shall return to righteousness, and all the upright in heart shall follow it. Who will rise up for me against the evildoers? Who will stand up for me against the workers of iniquity? Had the Lord not been my help, my soul would have soon dwelt in silence. When I said: My foot has slipped—Your kindness, O Lord, supported me. When my thoughts multiply within me, Your consolations delight my soul. Can the throne of wickedness be associated with You—one that makes mischief by statute? They band together against the soul of the righteous, and condemn innocent blood. But the Lord has been my stronghold, and my God the rock of my refuge. He will turn their own iniquity upon them, and destroy them through their own wickedness; the Lord our God will destroy them.",
    },
    {
      id: "shir-yom-chamishi",
      title: "Thursday - Psalm 81",
      titleHe: "יום חמישי - תהלים פא",
      instruction: "The psalm for Thursday.",
      text: "הַיּוֹם יוֹם חֲמִישִׁי בְּשַׁבָּת, שֶׁבּוֹ הָיוּ הַלְוִיִּם אוֹמְרִים בְּבֵית הַמִּקְדָּשׁ:\n\nלַמְנַצֵּחַ עַל הַגִּתִּית לְאָסָף. הַרְנִינוּ לֵאלֹהִים עוּזֵּנוּ, הָרִיעוּ לֵאלֹהֵי יַעֲקֹב. שְׂאוּ זִמְרָה וּתְנוּ תוֹף, כִּנּוֹר נָעִים עִם נָבֶל. תִּקְעוּ בַחֹדֶשׁ שׁוֹפָר, בַּכֵּסֶה לְיוֹם חַגֵּנוּ. כִּי חֹק לְיִשְׂרָאֵל הוּא, מִשְׁפָּט לֵאלֹהֵי יַעֲקֹב. עֵדוּת בִּיהוֹסֵף שָׂמוֹ, בְּצֵאתוֹ עַל אֶרֶץ מִצְרָיִם, שְׂפַת לֹא יָדַעְתִּי אֶשְׁמָע. הֲסִירוֹתִי מִסֵּבֶל שִׁכְמוֹ, כַּפָּיו מִדּוּד תַּעֲבֹרְנָה. בַּצָּרָה קָרָאתָ וָאֲחַלְּצֶךָּ, אֶעֶנְךָ בְּסֵתֶר רַעַם, אֶבְחָנְךָ עַל מֵי מְרִיבָה סֶלָה. שְׁמַע עַמִּי וְאָעִידָה בָּךְ, יִשְׂרָאֵל אִם תִּשְׁמַע לִי. לֹא יִהְיֶה בְךָ אֵל זָר, וְלֹא תִשְׁתַּחֲוֶה לְאֵל נֵכָר. אָנֹכִי ה' אֱלֹהֶיךָ, הַמַּעַלְךָ מֵאֶרֶץ מִצְרָיִם, הַרְחֶב פִּיךָ וַאֲמַלְאֵהוּ. וְלֹא שָׁמַע עַמִּי לְקוֹלִי, וְיִשְׂרָאֵל לֹא אָבָה לִי. וָאֲשַׁלְּחֵהוּ בִּשְׁרִירוּת לִבָּם, יֵלְכוּ בְּמוֹעֲצוֹתֵיהֶם. לוּ עַמִּי שׁוֹמֵעַ לִי, יִשְׂרָאֵל בִּדְרָכַי יְהַלֵּכוּ. כִּמְעַט אוֹיְבֵיהֶם אַכְנִיעַ, וְעַל צָרֵיהֶם אָשִׁיב יָדִי. מְשַׂנְאֵי ה' יְכַחֲשׁוּ לוֹ, וִיהִי עִתָּם לְעוֹלָם. וַיַּאֲכִילֵהוּ מֵחֵלֶב חִטָּה, וּמִצּוּר דְּבַשׁ אַשְׂבִּיעֶךָ.",
      translation: "Today is the fifth day of the week, on which the Levites would recite in the Temple:\n\nFor the Conductor, on the gittis, by Asaph. Sing joyously to God, our strength; shout to the God of Jacob. Raise a song, sound the drum, the sweet harp with the lute. Blow the shofar at the new moon, at the appointed time for the day of our festival. For it is a statute for Israel, a judgment of the God of Jacob. He established it as a testimony in Joseph when He went forth over the land of Egypt—a language I did not know, I heard. I removed the burden from his shoulder; his hands were freed from the basket. In distress you called and I delivered you; I answered you in the hidden thunder; I tested you at the waters of Merivah, Selah. Hear, My people, and I will admonish you; Israel, if you would listen to Me! There shall be no strange god within you, nor shall you bow down to a foreign god. I am the Lord your God Who brought you up from the land of Egypt; open your mouth wide, and I will fill it. But My people did not listen to My voice, and Israel did not want Me. So I sent them away for the stubbornness of their heart, to follow their own counsels. If only My people would listen to Me, if Israel would walk in My ways! I would quickly subdue their enemies, and turn My hand against their oppressors. Those who hate the Lord would deny Him, and their punishment would last forever. He would feed them with the finest wheat, and I would satisfy you with honey from the rock.",
    },
    {
      id: "shir-yom-shishi",
      title: "Friday - Psalm 93",
      titleHe: "יום שישי - תהלים צג",
      instruction: "The psalm for Friday.",
      text: "הַיּוֹם יוֹם שִׁשִּׁי בְּשַׁבָּת, שֶׁבּוֹ הָיוּ הַלְוִיִּם אוֹמְרִים בְּבֵית הַמִּקְדָּשׁ:\n\nה' מָלָךְ גֵּאוּת לָבֵשׁ, לָבֵשׁ ה' עֹז הִתְאַזָּר, אַף תִּכּוֹן תֵּבֵל בַּל תִּמּוֹט. נָכוֹן כִּסְאֲךָ מֵאָז, מֵעוֹלָם אָתָּה. נָשְׂאוּ נְהָרוֹת ה', נָשְׂאוּ נְהָרוֹת קוֹלָם, יִשְׂאוּ נְהָרוֹת דָּכְיָם. מִקֹּלוֹת מַיִם רַבִּים, אַדִּירִים מִשְׁבְּרֵי יָם, אַדִּיר בַּמָּרוֹם ה'. עֵדוֹתֶיךָ נֶאֶמְנוּ מְאֹד, לְבֵיתְךָ נָאֲוָה קוֹדֶשׁ, ה' לְאוֹרֶךְ יָמִים.",
      translation: "Today is the sixth day of the week, on which the Levites would recite in the Temple:\n\nThe Lord is King, He has clothed Himself with majesty; the Lord has clothed Himself, He has girded Himself with strength; indeed, the world is established, immovable. Your throne is established of old; You are from eternity. The rivers have raised, O Lord, the rivers have raised their voice; the rivers raise their raging waves. More than the sound of many waters, mightier than the breakers of the sea, mighty on high is the Lord. Your testimonies are very faithful; holiness befits Your House, O Lord, for the length of days.",
    },
    {
      id: "ldavid-hashem-ori",
      title: "L'David Hashem Ori - Psalm 27",
      titleHe: "לדוד ה' אורי - תהלים כז",
      instruction: "Recited from Rosh Chodesh Elul through Shemini Atzeres, after Shir Shel Yom at Shacharis and after Aleinu at Maariv.",
      text: "לְדָוִד, ה' אוֹרִי וְיִשְׁעִי מִמִּי אִירָא, ה' מָעוֹז חַיַּי מִמִּי אֶפְחָד.\nבִּקְרֹב עָלַי מְרֵעִים לֶאֱכֹל אֶת בְּשָׂרִי, צָרַי וְאֹיְבַי לִי, הֵמָּה כָשְׁלוּ וְנָפָלוּ.\nאִם תַּחֲנֶה עָלַי מַחֲנֶה לֹא יִירָא לִבִּי, אִם תָּקוּם עָלַי מִלְחָמָה בְּזֹאת אֲנִי בוֹטֵחַ.\nאַחַת שָׁאַלְתִּי מֵאֵת ה' אוֹתָהּ אֲבַקֵּשׁ, שִׁבְתִּי בְּבֵית ה' כָּל יְמֵי חַיַּי, לַחֲזוֹת בְּנֹעַם ה' וּלְבַקֵּר בְּהֵיכָלוֹ.\nכִּי יִצְפְּנֵנִי בְּסֻכֹּה בְּיוֹם רָעָה, יַסְתִּרֵנִי בְּסֵתֶר אָהֳלוֹ, בְּצוּר יְרוֹמְמֵנִי.\nוְעַתָּה יָרוּם רֹאשִׁי עַל אֹיְבַי סְבִיבוֹתַי, וְאֶזְבְּחָה בְאָהֳלוֹ זִבְחֵי תְרוּעָה, אָשִׁירָה וַאֲזַמְּרָה לַה'.\nשְׁמַע ה' קוֹלִי אֶקְרָא, וְחָנֵּנִי וַעֲנֵנִי.\nלְךָ אָמַר לִבִּי בַּקְּשׁוּ פָנָי, אֶת פָּנֶיךָ ה' אֲבַקֵּשׁ.\nאַל תַּסְתֵּר פָּנֶיךָ מִמֶּנִּי, אַל תַּט בְּאַף עַבְדֶּךָ, עֶזְרָתִי הָיִיתָ, אַל תִּטְּשֵׁנִי וְאַל תַּעַזְבֵנִי אֱלֹהֵי יִשְׁעִי.\nכִּי אָבִי וְאִמִּי עֲזָבוּנִי, וַה' יַאַסְפֵנִי.\nהוֹרֵנִי ה' דַּרְכֶּךָ, וּנְחֵנִי בְּאֹרַח מִישׁוֹר לְמַעַן שׁוֹרְרָי.\nאַל תִּתְּנֵנִי בְּנֶפֶשׁ צָרָי, כִּי קָמוּ בִי עֵדֵי שֶׁקֶר וִיפֵחַ חָמָס.\nלוּלֵא הֶאֱמַנְתִּי לִרְאוֹת בְּטוּב ה' בְּאֶרֶץ חַיִּים.\nקַוֵּה אֶל ה', חֲזַק וְיַאֲמֵץ לִבֶּךָ, וְקַוֵּה אֶל ה'.",
      translation: "By David. The Lord is my light and my salvation—whom shall I fear? The Lord is the stronghold of my life—of whom shall I be afraid?\nWhen evildoers came upon me to devour my flesh, my tormentors and my foes—they stumbled and fell.\nThough an army encamp against me, my heart shall not fear; though war rise up against me, in this I trust.\nOne thing I have asked of the Lord, this is what I seek: that I may dwell in the house of the Lord all the days of my life, to behold the graciousness of the Lord and to visit in His Temple.\nFor He will hide me in His shelter on the day of evil; He will conceal me in the cover of His tent; He will lift me up upon a rock.\nAnd now my head is raised above my enemies around me, and I will offer in His tent sacrifices with trumpeting; I will sing and chant praises to the Lord.\nHear, O Lord, my voice when I call; be gracious to me and answer me.\nOf You my heart has said: Seek My face. Your face, Lord, I will seek.\nDo not hide Your face from me; do not turn Your servant away in anger. You have been my help; do not abandon me and do not forsake me, God of my salvation.\nThough my father and mother have forsaken me, the Lord will take me in.\nTeach me Your way, O Lord, and lead me on a level path, because of my watchful enemies.\nDo not deliver me to the will of my tormentors, for false witnesses have risen against me, breathing violence.\nHad I not believed that I would see the goodness of the Lord in the land of the living!\nHope in the Lord; be strong and let your heart take courage, and hope in the Lord.",
    },
    {
      id: "barchi-nafshi",
      title: "Barchi Nafshi - Psalm 104",
      titleHe: "ברכי נפשי - תהלים קד",
      instruction: "Recited on Rosh Chodesh after Shir Shel Yom.",
      text: "בָּרֲכִי נַפְשִׁי אֶת ה', ה' אֱלֹהַי גָּדַלְתָּ מְּאֹד, הוֹד וְהָדָר לָבָשְׁתָּ.\nעֹטֶה אוֹר כַּשַּׂלְמָה, נוֹטֶה שָׁמַיִם כַּיְרִיעָה.\nהַמְקָרֶה בַמַּיִם עֲלִיּוֹתָיו, הַשָּׂם עָבִים רְכוּבוֹ, הַמְהַלֵּךְ עַל כַּנְפֵי רוּחַ.\nעֹשֶׂה מַלְאָכָיו רוּחוֹת, מְשָׁרְתָיו אֵשׁ לֹהֵט.\nיָסַד אֶרֶץ עַל מְכוֹנֶיהָ, בַּל תִּמּוֹט עוֹלָם וָעֶד.\nתְּהוֹם כַּלְּבוּשׁ כִּסִּיתוֹ, עַל הָרִים יַעַמְדוּ מָיִם.\nמִן גַּעֲרָתְךָ יְנוּסוּן, מִן קוֹל רַעַמְךָ יֵחָפֵזוּן.\nיַעֲלוּ הָרִים יֵרְדוּ בְקָעוֹת, אֶל מְקוֹם זֶה יָסַדְתָּ לָהֶם.\nגְּבוּל שַׂמְתָּ בַּל יַעֲבֹרוּן, בַּל יְשׁוּבוּן לְכַסּוֹת הָאָרֶץ.\nהַמְשַׁלֵּחַ מַעְיָנִים בַּנְּחָלִים, בֵּין הָרִים יְהַלֵּכוּן.\nיַשְׁקוּ כָּל חַיְתוֹ שָׂדָי, יִשְׁבְּרוּ פְרָאִים צְמָאָם.\nעֲלֵיהֶם עוֹף הַשָּׁמַיִם יִשְׁכּוֹן, מִבֵּין עֳפָאיִם יִתְּנוּ קוֹל.\nמַשְׁקֶה הָרִים מֵעֲלִיּוֹתָיו, מִפְּרִי מַעֲשֶׂיךָ תִּשְׂבַּע הָאָרֶץ.\nמַצְמִיחַ חָצִיר לַבְּהֵמָה וְעֵשֶׂב לַעֲבֹדַת הָאָדָם, לְהוֹצִיא לֶחֶם מִן הָאָרֶץ.\nוְיַיִן יְשַׂמַּח לְבַב אֱנוֹשׁ, לְהַצְהִיל פָּנִים מִשָּׁמֶן, וְלֶחֶם לְבַב אֱנוֹשׁ יִסְעָד.\nיִשְׂבְּעוּ עֲצֵי ה', אַרְזֵי לְבָנוֹן אֲשֶׁר נָטָע.\nאֲשֶׁר שָׁם צִפֳּרִים יְקַנֵּנוּ, חֲסִידָה בְּרוֹשִׁים בֵּיתָהּ.\nהָרִים הַגְּבֹהִים לַיְּעֵלִים, סְלָעִים מַחְסֶה לַשְׁפַנִּים.\nעָשָׂה יָרֵחַ לְמוֹעֲדִים, שֶׁמֶשׁ יָדַע מְבוֹאוֹ.\nתָּשֶׁת חֹשֶׁךְ וִיהִי לָיְלָה, בּוֹ תִרְמֹשׂ כָּל חַיְתוֹ יָעַר.\nהַכְּפִירִים שֹׁאֲגִים לַטָּרֶף, וּלְבַקֵּשׁ מֵאֵל אָכְלָם.\nתִּזְרַח הַשֶּׁמֶשׁ יֵאָסֵפוּן, וְאֶל מְעוֹנֹתָם יִרְבָּצוּן.\nיֵצֵא אָדָם לְפָעֳלוֹ, וְלַעֲבֹדָתוֹ עֲדֵי עָרֶב.\nמָה רַבּוּ מַעֲשֶׂיךָ ה', כֻּלָּם בְּחָכְמָה עָשִׂיתָ, מָלְאָה הָאָרֶץ קִנְיָנֶךָ.\nזֶה הַיָּם גָּדוֹל וּרְחַב יָדָיִם, שָׁם רֶמֶשׂ וְאֵין מִסְפָּר, חַיּוֹת קְטַנּוֹת עִם גְּדֹלוֹת.\nשָׁם אֳנִיּוֹת יְהַלֵּכוּן, לִוְיָתָן זֶה יָצַרְתָּ לְשַׂחֶק בּוֹ.\nכֻּלָּם אֵלֶיךָ יְשַׂבֵּרוּן, לָתֵת אָכְלָם בְּעִתּוֹ.\nתִּתֵּן לָהֶם יִלְקֹטוּן, תִּפְתַּח יָדְךָ יִשְׂבְּעוּן טוֹב.\nתַּסְתִּיר פָּנֶיךָ יִבָּהֵלוּן, תֹּסֵף רוּחָם יִגְוָעוּן וְאֶל עֲפָרָם יְשׁוּבוּן.\nתְּשַׁלַּח רוּחֲךָ יִבָּרֵאוּן, וּתְחַדֵּשׁ פְּנֵי אֲדָמָה.\nיְהִי כְבוֹד ה' לְעוֹלָם, יִשְׂמַח ה' בְּמַעֲשָׂיו.\nהַמַּבִּיט לָאָרֶץ וַתִּרְעָד, יִגַּע בֶּהָרִים וְיֶעֱשָׁנוּ.\nאָשִׁירָה לַה' בְּחַיָּי, אֲזַמְּרָה לֵאלֹהַי בְּעוֹדִי.\nיֶעֱרַב עָלָיו שִׂיחִי, אָנֹכִי אֶשְׂמַח בַּה'.\nיִתַּמּוּ חַטָּאִים מִן הָאָרֶץ וּרְשָׁעִים עוֹד אֵינָם, בָּרֲכִי נַפְשִׁי אֶת ה', הַלְלוּיָהּ.",
      translation: "Bless the Lord, O my soul. O Lord my God, You are very great; You are clothed with glory and majesty.\nWho covers Yourself with light as with a garment, who stretches out the heavens like a curtain;\nWho lays the beams of His upper chambers in the waters, who makes the clouds His chariot, who walks upon the wings of the wind;\nWho makes winds His messengers, the flaming fire His ministers.\nWho established the earth upon its foundations, that it should not be moved forever and ever;\nYou covered it with the deep as with a garment; the waters stood above the mountains.\nAt Your rebuke they fled, at the voice of Your thunder they hastened away—\nThe mountains rose, the valleys sank down—to the place which You had founded for them;\nYou set a boundary which they should not pass over, that they might not return to cover the earth.\nWho sends forth springs into the valleys; they flow between the mountains;\nThey give drink to every beast of the field; the wild donkeys quench their thirst.\nBeside them the birds of the heaven dwell; from among the branches they sing.\nWho waters the mountains from His upper chambers; the earth is satisfied from the fruit of Your works.\nWho causes the grass to spring up for the cattle, and vegetation for the labor of man, to bring forth bread from the earth,\nAnd wine that gladdens the heart of man, making the face brighter than oil, and bread that sustains man's heart.\nThe trees of the Lord have their fill, the cedars of Lebanon which He planted;\nWherein the birds make their nests; as for the stork, the fir trees are her house.\nThe high mountains are for the wild goats; the rocks are a refuge for the rabbits.\nHe made the moon for the festivals; the sun knows its setting.\nYou make darkness, and it is night, in which all the beasts of the forest creep forth.\nThe young lions roar for prey, and seek their food from God.\nThe sun rises, they gather themselves together, and lie down in their dens.\nMan goes forth to his work and to his labor until the evening.\nHow manifold are Your works, O Lord! In wisdom You have made them all; the earth is full of Your creatures.\nYonder sea, great and wide—therein are creeping things innumerable, living creatures both small and great.\nThere go the ships; there is leviathan, whom You have formed to sport therein.\nAll of them wait for You, to give them their food in due season.\nYou give it to them, they gather it; You open Your hand, they are satisfied with good.\nYou hide Your face, they are dismayed; You withdraw their breath, they perish and return to their dust.\nYou send forth Your spirit, they are created; and You renew the face of the earth.\nMay the glory of the Lord endure forever; let the Lord rejoice in His works!\nWho looks on the earth, and it trembles; He touches the mountains, and they smoke.\nI will sing to the Lord as long as I live; I will sing praise to my God while I have my being.\nLet my meditation be sweet to Him; I will rejoice in the Lord.\nLet sinners cease from the earth, and let the wicked be no more. Bless the Lord, O my soul. Hallelujah.",
    },
  ],
};
