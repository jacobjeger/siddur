...
export const holidaysServiceForLightingChanukahCandles: Tefila = {
  id: "holidays-service-for-lighting-chanukah-candles",
  name: "Service for Lighting Chanukah Candles",
  nameHe: "סדר הדלקת נרות חנוכה",
  category: "holidays",
  timeContext: "anytime",
  sections: [
  {
    id: "festivals-chanukah-blessings-on-chanukah-candles",
    title: "Blessings on Chanukah Candles",
    titleHe: "ברכות הדלקת נרות חנוכה",
    instruction: `לפני ההדלקה מברכים:`,
    text: `בָּרוּךְ אַתָּה יְיָ אֱלֹהֵינוּ מֶלֶךְ הָעוֹלָם
...
export const ALL_FESTIVALS_CHANUKAH: Tefila[] = [
  holidaysServiceForLightingChanukahCandles,
];
