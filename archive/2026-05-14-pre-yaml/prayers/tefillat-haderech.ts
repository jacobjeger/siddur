...
export const otherTefillatHaderech: Tefila = {
  id: "other-tefillat-haderech",
  ...
  sections: [
  {
    id: "tefillat-haderech-tefillat-haderech",
...
export const ALL_TEFILLAT_HADERECH: Tefila[] = [
  otherTefillatHaderech,
];
